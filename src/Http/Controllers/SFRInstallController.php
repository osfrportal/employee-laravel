    ...
    private function configInsertDefValues()
    {
        SfrConfig::upsert(
            [
                ...
                ['configid' => Str::uuid(), 'key' => 'shedule_ImapDailyTime', 'value' => '07:39', 'description' => '', 'crypted' => false, 'groupname' => 'shedule'],
                ['configid' => Str::uuid(), 'key' => 'shedule_PersonsDailyTime', 'value' => '07:43', 'description' => '', 'crypted' => false, 'groupname' => 'shedule'],
                ['configid' => Str::uuid(), 'key' => 'shedule_MovementsDailyTime', 'value' => '07:45', 'description' => '', 'crypted' => false, 'groupname' => 'shedule'],
                ['configid' => Str::uuid(), 'key' => 'shedule_DepatrmentsDailyTime', 'value' => '07:48', 'description' => '', 'crypted' => false, 'groupname' => 'shedule'],
                ['configid' => Str::uuid(), 'key' => 'shedule_VacationDailyTime', 'value' => '07:50', 'description' => '', 'crypted' => false, 'groupname' => 'shedule'],
                ['configid' => Str::uuid(), 'key' => 'shedule_DekretDailyTime', 'value' => '07:52', 'description' => '', 'crypted' => false, 'groupname' => 'shedule'],
                ['configid' => Str::uuid(), 'key' => 'orion_soap_url', 'value' => null, 'description' => '', 'crypted' => false, 'groupname' => 'main'],
                ['configid' => Str::uuid(), 'key' => 'ftp1c_host', 'value' => 'poib058backup.0058.pfr.ru', 'description' => '', 'crypted' => false, 'groupname' => 'main'],
                ['configid' => Str::uuid(), 'key' => 'ftp1c_user', 'value' => 'server1c', 'description' => '', 'crypted' => false, 'groupname' => 'main'],
                ['configid' => Str::uuid(), 'key' => 'ftp1c_password', 'value' => 'eyJpdiI6IlZVVVVMMUF4c28zODNiRVFqQTI3bXc9PSIsInZhbHVlIjoiTjJjUU9YVkNNR1lqbTZJRldZaERuQT09IiwibWFjIjoiYjI4ZWYzNTlkMjRiNWMxZDY2NGY3NzJkNWMyYmJiZmRhNDM0MWI3N2ZlMjA5OTkzYmFhNWVhMTVjODM1YmViMCIsInRhZyI6IiJ9', 'description' => '', 'crypted' => true, 'groupname' => 'main'],
                ['configid' => Str::uuid(), 'key' => 'ftp1c_ssl', 'value' => false, 'description' => '', 'crypted' => false, 'groupname' => 'main'],
                ['configid' => Str::uuid(), 'key' => 'ftp1c_passive', 'value' => true, 'description' => '', 'crypted' => false, 'groupname' => 'main'],
                ...
                ['configid' => Str::uuid(), 'key' => 'smtp_configured', 'value' => false, 'description' => 'Устанавливается автоматически при первой записи зашифрованного пароля в базу', 'crypted' => false, 'groupname' => 'mail'],
