...
use Osfrportal\OsfrportalLaravel\Jobs\SfrSaveCertToDBJob;
...
class SFRx509UnepService implements SFRx509Interface
{
    ...
    public function getAllCertsFromStorage(): Collection
    {
        ...
        Log::info('UNEP: количество сертификатов для обработки', [
            'response' => $this->collection_certs->count(),
        ]);
    ...
    {
        SfrSaveCertToDBJob::dispatch($certdata, $pid, CertsTypesEnum::UNEP());
        /*
