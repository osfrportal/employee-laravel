        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm @error('inputHsmLogin') is-invalid @enderror"
                        id="inputHsmLogin" name="inputHsmLogin" type="text"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="mb-1" for="inputSheduleSync1CDailyTime">shedule_Sync1CDailyTime</label>
                        <input
                            class="form-control form-control-sm @error('inputSheduleSync1CDailyTime') is-invalid @enderror"
                            id="inputSheduleSync1CDailyTime" name="inputSheduleSync1CDailyTime" type="time"
                            value="{{ old('inputSheduleSync1CDailyTime') ?? (config('osfrportal.shedule_Sync1CDailyTime') ?? '') }}"
                            width="200">
                        @error('inputSheduleSync1CDailyTime')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="mb-1" for="inputSheduleCRLWeeklyTime">CRLWeeklyTime</label>
                        <input
                            class="form-control form-control-sm @error('inputSheduleCRLWeeklyTime') is-invalid @enderror"
                            id="inputSheduleCRLWeeklyTime" name="inputSheduleCRLWeeklyTime" type="time"
                            value="{{ old('inputSheduleCRLWeeklyTime') ?? (config('osfrportal.shedule_CRLWeeklyTime') ?? '') }}"
                            width="200">
                        @error('inputSheduleCRLWeeklyTime')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
