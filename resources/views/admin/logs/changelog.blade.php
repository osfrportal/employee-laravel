    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <div class="d-flex text-muted pt-3 notifblock">
            ...
            <div class="pb-3 mb-0  lh-sm border-bottom w-100">
                <span class="d-block  mb-2">02-01-2024</span>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <i class="ti ti-code-plus icon-size-24" title="[ADD]"></i> Добавлен раздел Бизнес-ресурсы
                        &RightArrow; Криптосредства.
                    </li>
                </ul>
            </div>
        </div>
        <div class="d-flex text-muted pt-3 notifblock">
            ...
            <div class="pb-3 mb-0  lh-sm border-bottom w-100">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <i class="ti ti-code-plus icon-size-24" title="[ADD]"></i> Добавлено поле "Дата окончания действия
                        документа" в раздел нормативных документов.
                    </li>
                </ul>
            </div>
        </div>
        <div class="d-flex text-muted pt-3 notifblock">
            ...
            <div class="pb-3 mb-0  lh-sm border-bottom w-100">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <i class="ti ti-code-asterix icon-size-24" title="[FIX]"></i> Исправлена передача номеров
        ...
        <div class="d-flex text-muted pt-3 notifblock">
            ...
            <div class="pb-3 mb-0  lh-sm border-bottom w-100">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <i class="ti ti-code-asterix icon-size-24" title="[FIX]"></i> Исправлено отображение ведомости
                        ознакомления и профиля работника в
                        интерфейсе администратора. (ошибка в случае ознакомления рабоника УНЭПом)
                    </li>
                    <li class="list-group-item">
                        <i class="ti ti-code-dots icon-size-24" title="[TEST]"></i> Добавлены уведомления о синхронизации.
